package club.iananderson.seasonhud.impl.trinkets.item;

import club.iananderson.seasonhud.impl.trinkets.TrinketsCalendar;
...
public class CalendarSlot extends CalendarItem implements ICurioItem {
    ...
    public static void sendImc(InterModEnqueueEvent event) {
        if (curiosLoaded())
            TrinketsCalendar.registerSlots();
    }

    @Override
    public ICapabilityProvider initCapabilities(final ItemStack stack, CompoundTag unused) {
        if (curiosLoaded()) {
            return TrinketsCalendar.initCapabilities();
        }
